...
const Projects = forwardRef<HTMLDivElement>(function Projects(_props, ref) {
  ...
  const projectEntries = [
    ...
    {name: 'RNA Sequence Comparison & Patch Tool', date: 'Spring 2021',
      technologies: ['Python', 'TF-IDF', 'Information Retrieval', ],
      description: 'This tool compares two RNA sequences and identifies the differences between them. It uses TF-IDF vectors along with IR distance algorithms to parse and compare the sequences. The tool outputs a patch file that can be used to update one sequence to match the other.',
